            ...
            <div class="admin-table-wrapper">
                <table class="admin-table">
                    ...
                    <tbody>
                        <?php if (empty($orders)): ?>
                            <tr>
                                <td colspan="5" style="text-align: center; padding: 20px;">Aucune commande n'a été passée pour le moment.</td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($orders as $order): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(date('d/m/Y H:i', strtotime($order['order_date']))); ?></td>
                                <td>
                                    <a href="#" class="btn-primary" style="padding: 5px 10px; font-size: 12px; text-decoration: none; border-radius: 5px;">Voir détails</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
